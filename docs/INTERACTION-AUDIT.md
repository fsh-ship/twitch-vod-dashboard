...
| Live refresh, playlist refresh, settings-file check | G | Slice 11d1 adds shared short-action pending labels with real disabled state and cleanup. Settings saves remain 11d2; long-running operational controls remain 11d3/review. | 11d1/11d2/11d3 |
