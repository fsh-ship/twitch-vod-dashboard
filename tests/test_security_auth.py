...
class AuthenticationAndCsrfTests(unittest.TestCase):
    ...
    def test_api_access_without_login_returns_json_401(self):
        ...
        auto_youtube_cleanup = self.client.post(
            "/api/auto-youtube/cleanup/keep-local",
            json={"streamer": "nika_livetv", "twitch_vod_id": "2855270041", "media_path": "nika/source.mp4", "keep_local": True},
        )
        ...
        self.assertEqual(auto_youtube_cleanup.status_code, 401)
    ...
    def test_missing_csrf_token_is_rejected(self):
        ...
        self.assertEqual(auto_youtube_cleanup.status_code, 403)
    ...
    def test_invalid_csrf_token_is_rejected(self):
        ...
        self.assertEqual(auto_youtube_cleanup.status_code, 403)
        self.assertIn("CSRF", auto_youtube_cleanup.get_json()["error"])
    ...
    def test_invalid_origin_is_rejected(self):
        ...
        self.assertEqual(auto_youtube_cleanup.status_code, 403)
        self.assertIn("origin", auto_youtube_cleanup.get_json()["error"])
